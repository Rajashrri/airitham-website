...
const BlogDetail = () => {
  ...
  const blog_HEADER_CONFIG = {
    heading: "Revolutionizing AI with Neural Networks",
    headclass: "false",
        ...
        <div className="py-[80px] lg:px-0 px-4 max-w-[1130px] m-auto">
          <div className="blogdetails">
            <div className="heading">
              <div className="kds">
              <h2 className="text-[#015190]">Revolutionizing AI with Neural Networks and Deep Learning</h2>
              <div className="tags">
  ...
  <mask id="mask0_3883_933"  maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
    <path d="M0 0H23.4612V23.4612H0V0Z" fill="white"/>
  </mask>
  <g mask="url(#mask0_3883_933)">
    <path d="M18.4757 1.09937H22.0736L14.2141 10.1051L23.4612 22.3619H16.2217L10.5475 14.9297L4.06214 22.3619H0.460845L8.86666 12.7261L0 1.10104H7.42379L12.545 7.89306L18.4757 1.09937ZM17.2105 20.2035H19.2047L6.33452 3.14552H4.1962L17.2105 20.2035Z" fill="#015190"/>
  </g>
</svg>
                    </a>
                  </li>
  ...
  <path d="M3.59688 16.2H1.79688V3.60005C1.79687 3.12266 1.98652 2.66482 2.32408 2.32726C2.66165 1.98969 3.11949 1.80005 3.59688 1.80005H16.1969V3.60005H3.59688V16.2Z" fill="#015190"/>
            ...
            <div className="blogbody mt-[24px]">
              <figure>
                <img src="https://images.unsplash.com/photo-1535223289827-42f1e9919769?q=80&w=800" className="h-[600px] rounded-[4px] w-full object-cover" alt="" />
              </figure>
              <p>Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions. Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions.Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions.Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions.Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions.Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions.Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions.Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions.</p>
              <h3>Revolutionizing AI with Neural Networks Revolutionizing AI with </h3>
              <p>Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions. Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions.Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions.Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions.Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions.Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions.Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions.Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions.</p>
              <h3>Revolutionizing AI with Neural Networks Revolutionizing AI with </h3>
              <ul>
                <li>Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions. </li>
                <li>Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions.Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage </li>
                <li>Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions.</li>
                <li>Examining cutting-edge technologies enhancing the efficiency and scalability of renewable energy storage solutions.Examining </li>
              </ul>
            </div>
            <h1 className="mb-[40px] mt-[82px] text-[#015190] text-[40px] font-primary font-[600]">Related Blogs</h1>

             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[16px] mx-auto">
            {blogs.map((blog) => (
              <a href="#!"
                key={blog.id}
